...
{
    /**
     * @var \Orba\Ceneopl\Helper\Serialize\Serializer\Base64Json
     */
    private $base64json;
    ...
    protected function setUp()
    {
        ...
        $this->base64json = $objectManager->getObject(\Orba\Ceneopl\Helper\Serialize\Serializer\Base64Json::class, [
            'jsonSerializer' => new \Orba\Ceneopl\Helper\Serialize\Serializer\Json()
        ]);
    }
